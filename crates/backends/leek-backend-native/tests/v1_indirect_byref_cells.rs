...
fn v1_indirect_byref_or_skip() {
    let cases: &[(&str, &str, u8)] = &[
        (
            "var f = function(@a) { a++ } var b = 10 f(b) return b",
            "11",
            1,
        ),
        (
            "var f = function(@a) { a = 99 } var b = 10 f(b) return b",
            "99",
            1,
        ),
        (
            "var f = function(@a) { push(a, 5) } var b = [] f(b) return b",
            "[5]",
            1,
        ),
        ...
        (
            "var _count = count; count = function(x) { return _count(x) } return count([1, 2, 3])",
            "3",
            1,
        ),
        (
            "var a = toUpper, b = arrayMap return b(['a', 'b'], a)",
            "[\"A\", \"B\"]",
            1,
        ),
        ...
        (
            "var f = function(@a) { return function() { a += 2 } }; var x = 10 f(x)() return x",
            "12",
            1,
        ),
    ];
