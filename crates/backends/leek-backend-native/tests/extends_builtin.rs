...
fn extends_builtin_collapses_or_skips() {
    let cases: &[(&str, &str, u8)] = &[
        ...
        (
            "class A extends Array {} var a = new A() push(a, 12) return a",
            "[12]",
            4,
        ),
        (
        ...
        (
            "class A extends Array {} var a = new A() if (a instanceof A) { return 1 } return 0",
            "0",
            4,
        ),
        (
            "class M extends Map {} var m = new M() m['k'] = 5 return m['k']",
            "5",
            4,
        ),
    ];
