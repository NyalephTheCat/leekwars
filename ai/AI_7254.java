...
public class AI_7254 extends AI {
public class u_A extends LegacyArrayLeekValue {
public u_A() throws LeekRunException {
super(AI_7254.this);
allocateRAM(this, 0);
}
public u_A(u_A o, int level) throws LeekRunException {
super(AI_7254.this, o, level);
}
...
public AI_7254() throws LeekRunException {
super(0, 3);
u_A.setParent(legacyArrayClass);
...
protected String getAIString() { return "<snippet 7254>";}
