...
public class AI_13110 extends AI {
...
public AI_13110() throws LeekRunException {
super(3, 2);
...
protected String getAIString() { return "<snippet 13110>";}
protected String[] getErrorFiles() { return new String[] {"<snippet 13110>", };}

protected int[] getErrorFilesID() { return new int[] {13110, };}
