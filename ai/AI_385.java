...
public class AI_385 extends AI {
public AI_385() throws LeekRunException {
super(2, 2);
}
...
protected String getAIString() { return "<snippet 385>";}
protected String[] getErrorFiles() { return new String[] {"<snippet 385>", };}

protected int[] getErrorFilesID() { return new int[] {385, };}
