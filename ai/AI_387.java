...
public class AI_387 extends AI {
public AI_387() throws LeekRunException {
super(2, 4);
}
public void staticInit() throws LeekRunException {
}
public Object runIA(Session session) throws LeekRunException {
Object u_ax = ops(NumberClass.randInt(AI_387.this, -17l, 17l), 32);
Object u_ay = ops(Number_randInt_ii((Object) add(-17l, Number_abs_r_i_l(u_ax)), (Object) sub(17l, Number_abs_r_i_l(u_ax))), 38);
return null;
}
protected String getAIString() { return "<snippet 387>";}
protected String[] getErrorFiles() { return new String[] {"<snippet 387>", };}

protected int[] getErrorFilesID() { return new int[] {387, };}
