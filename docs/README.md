...
| [`crate-graph.md`](crate-graph.md) | The workspace's crate graph as a mermaid diagram. Generated by `cargo xtask graph` and drift-checked in CI — do not edit by hand. |
| [`pipeline.md`](pipeline.md) | The query layer: the salsa inputs, every tracked query, what an edit invalidates, and what the two-orchestration-models migration replaced. |
